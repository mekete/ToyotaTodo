...
import com.toyota.todo.ui.main.viewmodel.ItemDetailsUiState
import com.toyota.todo.ui.main.viewmodel.ItemDetailsViewModel
import com.toyota.todo.ui.main.viewmodel.toItem
    ...
    Card(
        ...
        Column(
            ...
            ItemDetailsRow(
                ...
                itemDetail = item.description.toString(),
                modifier = Modifier.padding(
                    horizontal = dimensionResource(
                        id = R.dimen
                            .padding_medium
...
fun ItemDetailsScreenPreview() {
    TodoTheme {
        ItemDetailsBody(ItemDetailsUiState(
            emptyDescription = true, itemDetails = com.toyota.todo.ui.main.viewmodel.ItemDetails(1, "Pen", "10")
        ),  onDelete = {})
    }
}
